...
// ANSWER: O(1), you could not write a function with a better time complexity.
...
// The time complexity is: O(n), I don't know if I could ever get it to O(1), because the function will always be able to take in a number with an indetermined number of digits which decides the number of operations.
